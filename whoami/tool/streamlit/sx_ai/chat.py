...
def render_chat_interface():
    """Render the chat interface to match the screenshot."""
    # Create a container for the header
    st.markdown("""
    <div class="chat-header">
        <div class="avatar-container">
            <img src="https://i.imgur.com/gjzXgY7.png" class="avatar-img" alt="SX AI Avatar">
            <div class="greeting-text">有疑问吗? 联系我们!</div>
    ...
    # Create a container with specific height for the chat messages
    with st.container():
    ...
    with col2:
        # Chat input field
        if st.session_state.audio_text and not st.session_state.waiting_for_response:
            ...
            st.session_state.audio_text = ""
            # Reset waiting state after handling
            st.session_state.waiting_for_response = False
        else:
            # Disable the input when waiting for response
            prompt = st.chat_input("输入你的信息...", key="chat_input", disabled=st.session_state.waiting_for_response)
