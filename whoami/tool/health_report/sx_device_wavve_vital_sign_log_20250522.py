...
class SxDeviceWavveVitalSignLog(Base):
    __tablename__ = 'sx_device_wavve_vital_sign_log_20250522'
    ...
    deleted = Column(LargeBinary(1), nullable=True, server_default='0', comment='是否删除')  # bit(1) 类型对应 LargeBinary(1)
