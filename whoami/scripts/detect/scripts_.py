...
from whoami.tool.base.thread_management import ThreadManager
...
async def warning_fastapi(request_data: RequestData):
    ...
    for topic_del in difference:
        ...
        thread_manager.stop_thread(task_id_to_stop)
    ...
    for topic in need_open_topic_list:
        ...
        thread_manager.start_thread(thread_id, sx_video_stream_detector_thread)
...
async def get_thread_status():
    """获取所有线程的状态"""
    return R.success(thread_manager.get_running_threads())
