...
LOG_PATH=$PROJECT_ROOT/whoami/logs/bcg_real_time
...
nohup streamlit run whoami/tool/streamlit/health_report/pages/bcg_real_time_vital.py --server.address 0.0.0.0 --server.port 5555  > "$LOG_FILE" 2>&1 &
